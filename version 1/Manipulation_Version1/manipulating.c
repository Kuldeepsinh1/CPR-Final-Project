...
Purpose: [This program takes 2 strings as an input and concatenates them, We can use this program
			if we want to join two different words/letters and form a new word for a different use.]
*/
