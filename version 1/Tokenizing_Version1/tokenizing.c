...
void tokenizing(void) //Calling the function tokenizing that returns no value and no input is needed
{
    ...
    char words[BUFFER_SIZE]; // declaring a character array the size of BUFFER_SIZE
    char* nextWord = NULL; // declaring a pointer named nextWord equating to NULL
    int wordsCounter; // declaring an integer named wordsCounter
