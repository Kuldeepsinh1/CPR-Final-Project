...
#include "tokenizing.h" //including the use of header file tokenizing.h
#define BUFFER_SIZE 300 // Macro BUFFER_SIZE is being set to 300
...
void tokenizing(void) //Calling the function tokenizing that returns no value and no input is needed
{
    ...
    // declaring a character array the size of BUFFER_SIZE
    char* nextWord = NULL; 
    // declaring a pointer named nextWord equating to NULL
    int wordsCounter; 
    // declaring an integer named wordsCounter
        ...
        // in this case it would be 
    {
        ...
        // this assigns the last character of the string words to a null character
        ...
        if (strcmp(words, "q") != 0)
        {
           ...
           // uses the strtok function to break the string words into smaller strings also known as tokens
           // the " " represents a delimiter letting the program know the beginning and end of a sequence
            // the string words is being returned by strtok and is stored in next Word
            
            wordsCounter = 1;

            // the number of time the loop iterates is equating to 1 is stored in the variable wordsCounter
           ...
           
            {
                ...
                //prints out the pointer nextWord and displays what words the user enters and which number the word is in the sequence
                ...
                // end of the sequence
                // the value is returned by strtok and stored in the string nextWord
            }
        }
